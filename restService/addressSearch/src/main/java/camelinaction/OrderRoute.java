...
public class OrderRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        rest("/orders").description("Order services")
            ...
            // oppstart crasher med nullpointer	
            //.responseMessage().code(200).endResponseMessage()
            .to("direct:ping")

            .get("/tore").apiDocs(false)
            .to("direct:tore")

            .get("address/{street}").outType(Order.class)
            .description("Service to get postal address from street name")
            .param().name("street").description("The street name").endParam()
            .responseMessage().code(200).message("The postal address for the given street").endResponseMessage()
            .responseMessage().code(404).message("Street name not found").endResponseMessage()
